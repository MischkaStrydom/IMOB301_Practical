...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public static final String KEY_ModuleID = "ModID";
    ...
    public void onCreate(SQLiteDatabase db) {
      // Create Admin table
        ...
        db.execSQL("create table " + TABLE_MODULE +
                "(ModID INTEGER PRIMARY KEY AUTOINCREMENT, ModName TEXT, " +
                "ModDuration INTEGER)");
        ...
        db.execSQL("create table " + TABLE_TASK +
                "(TaskID INTEGER PRIMARY KEY AUTOINCREMENT, TaskName TEXT, TaskDueDate DATE, TaskModule TEXT, Completed BOOLEAN, ModID INTEGER,  " +
                "FOREIGN KEY (ModID) REFERENCES TABLE_MODULES(ModID))");
    ...
    //Task
    public boolean insertTaskData(String taskName, String taskDueDate, String taskModule, Boolean Completed, int ModID) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        ...
        contentValues.put(KEY_ModuleID, ModID);
    ...
    public Cursor getAllItems(){
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_MODULE, null);
        return cursor;
    }
